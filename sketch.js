...
var obstaclesGroup, obstacle1, obstacle2, obstacle3, obstacle4, obstacle5, obstacle6,w2,re;
...
function setup() {
  ...
  gameover.addImage("gamo",w2);
  gameover.scale = 0.9;
   gameover.visible = false;
  restart = createSprite(300,140);
  restart.addImage("goag",re);
  restart.scale = 0.6;
